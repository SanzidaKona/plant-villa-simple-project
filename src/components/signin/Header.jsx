    ...
    <div className="sticky top-0 w-full z-50 bg-white/80 backdrop-blur-md border-b border-outline-variant/30">
      <div className="max-w-[1280px] mx-auto px-6 py-4 flex flex-col md:flex-row justify-between items-center bg-transparent ] ">
         <div className="flex items-center space-x-8">
          <span className="font-serif font-display text-4xl  text-[#05190e]  font-bold">Plant Villa</span>
         <div className=" font-sans hidden lg:flex space-x-6 text-[#08080880]">
            
            <Link className=" text-base text-[#05190e]/70 hover:text-[#05190e] font-bold transition-colors   " href="/">
              Indoor
            </Link>
